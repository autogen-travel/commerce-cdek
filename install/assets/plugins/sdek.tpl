 ...
 * СДЭК
 *
 * <strong>0.5</strong> Плагин для расчёта доставки СДЭК
 *
 * @category    plugin
 ...
 * @internal    @properties &sender_city=ID города отправки;number;44;;Узнать ID города можно здесь: https://dadata.ru/suggestions/#address (пункт Идентификаторы служб доставки) &client_id=СДЭК логин;string; &client_secret=СДЭК пароль;string; &yandexapikey=Ключ АПИ Я.Карт для отображения ПВЗ;string; &upsale=Наценка;text;0 &extradays=Добавлять дней к сроку доставки;number;0 &weight=Вес по умолчанию, в кг;number;0.5 &weight_tv=ID TV-параметра веса товара;number;;Вес в кг &length_tv=ID TV-параметра длины упаковки;number;;длина в см &width_tv=ID TV-параметра ширины упаковки;number;;ширина в см &height_tv=ID TV-параметра высоты упаковки;number;;высота в см &group=Объединять размеры в одну посылку;list;Нет==0||Да==1;0 &register=Регистрировать заявки в ЛК;list;Нет==0||Да==1;0
 * @internal    @disabled 0
